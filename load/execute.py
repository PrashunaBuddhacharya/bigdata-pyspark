...
def load_to_postgres(spark, input_dir):
    ...
    tables = [
        ("stage2/master_table", "master_table1"),
        ("stage3/recommendations_exploded", "recommendations_exploded1"),
        ("stage3/artist_track", "artist_track1"),
        ("stage3/track_metadata", "track_metadata1"),
        ("stage3/artist_metadata", "artist_metadata1")
    ]
